...
#define IS_TYPE_PHYSICAL(category)(category == MOVE_TYPE_PHYSICAL)
#define IS_TYPE_SPECIAL(category)(category == MOVE_TYPE_SPECIAL)
#define IS_TYPE_STATUS(category)(category == MOVE_TYPE_STATUS)
